...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiivisekse(self):
    ...
    def test_negatiivisen_summan_lataaminen_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-1200)
        
        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_kortilla_voi_ostaa_edullisen_lounaan_kun_juuri_riittava_saldo(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_kortilla_voi_ostaa_maukkaan_lounaan_kun_juuri_riittava_saldo(self):
